...
export const Footer = () => {
  return (
    <footer className="bg-[#56112a] text-[#f5f5f0] pt-20 pb-10 border-t border-[#6a1533]">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex items-center space-x-6 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
              <img src={partnerLogo1} alt="Socio 1" className="h-8 w-auto object-contain" />
              <img src={partnerLogo2} alt="Socio 2" className="h-8 w-auto object-contain" />
            </div>
          </div>
