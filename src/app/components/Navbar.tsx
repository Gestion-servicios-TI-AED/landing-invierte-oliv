  ...
  return (
    <nav
      className={clsx(
        ...
        scrolled ? "bg-[#6a1533]/95 backdrop-blur-md py-4 shadow-lg" : "bg-transparent py-6"
      )}
    >
      <div className="container mx-auto px-6 flex justify-center md:justify-between items-center">
        ...
        <div className="hidden md:flex items-center">
          <Link
            ...
            smooth={true}
            duration={800}
            className="px-6 py-2 bg-white text-[#572433] text-sm font-medium tracking-wide hover:bg-gray-100 transition-colors rounded-full cursor-pointer shadow-sm hover:shadow-md"
          >
            Ser Fundador
          </Link>
        </div>
